...
class Main:
    def __init__(self):
        ...
        self.to_email = input(
            'Email Address that you want to get alert , LEAVE BLANK if ' + self.email + ' : ') or self.email
    ...
    def check_price(self):
        ...
        if self.wished_price < self.price:
            ...
            print('*' * 150)
            print(
                'Hurray ! Seems like the price of ' + self.title + 'has fell down, Right Time to Order now \n\n' 'Click this link : : ' + self.url)
            print('*' * 150)
            time.sleep(3)
            self.send_mail()
